var ae=Object.defineProperty;var le=(e,t,n)=>t in e?ae(e,t,{enumerable:!0,configurable:!0,writable:!0,value:n}):e[t]=n;var V=(e,t,n)=>(le(e,typeof t!="symbol"?t+"":t,n),n);(function(){const t=document.createElement("link").relList;if(t&&t.supports&&t.supports("modulepreload"))return;for(const o of document.querySelectorAll('link[rel="modulepreload"]'))s(o);new MutationObserver(o=>{for(const r of o)if(r.type==="childList")for(const i of r.addedNodes)i.tagName==="LINK"&&i.rel==="modulepreload"&&s(i)}).observe(document,{childList:!0,subtree:!0});function n(o){const r={};return o.integrity&&(r.integrity=o.integrity),o.referrerPolicy&&(r.referrerPolicy=o.referrerPolicy),o.crossOrigin==="use-credentials"?r.credentials="include":o.crossOrigin==="anonymous"?r.credentials="omit":r.credentials="same-origin",r}function s(o){if(o.ep)return;o.ep=!0;const r=n(o);fetch(o.href,r)}})();const ue="modulepreload",de=function(e){return"/"+e},J={},Q=function(t,n,s){let o=Promise.resolve();if(n&&n.length>0){const r=document.getElementsByTagName("link"),i=document.querySelector("meta[property=csp-nonce]"),a=(i==null?void 0:i.nonce)||(i==null?void 0:i.getAttribute("nonce"));o=Promise.all(n.map(u=>{if(u=de(u),u in J)return;J[u]=!0;const f=u.endsWith(".css"),y=f?'[rel="stylesheet"]':"";if(!!s)for(let p=r.length-1;p>=0;p--){const c=r[p];if(c.href===u&&(!f||c.rel==="stylesheet"))return}else if(document.querySelector(`link[href="${u}"]${y}`))return;const d=document.createElement("link");if(d.rel=f?"stylesheet":ue,f||(d.as="script",d.crossOrigin=""),d.href=u,a&&d.setAttribute("nonce",a),document.head.appendChild(d),f)return new Promise((p,c)=>{d.addEventListener("load",p),d.addEventListener("error",()=>c(new Error(`Unable to preload CSS for ${u}`)))})}))}return o.then(()=>t()).catch(r=>{const i=new Event("vite:preloadError",{cancelable:!0});if(i.payload=r,window.dispatchEvent(i),!i.defaultPrevented)throw r})};let ee=(...e)=>console.log("SENDING BRIDGE REPLY",...e);(async()=>{try{const t="../../salmoning.js";ee=(await Q(()=>import(t),[])).bridge_reply}catch{console.warn("activating ui debug"),(await Q(()=>import("./debug-BxsjpJhi.js"),[])).activate()}})();function $(){return ee(...arguments)}const A=new Set,X=new Set;function z(e){return typeof e=="function"&&!!e.isT}function C(e){return typeof e=="object"&&e!==null&&"$on"in e&&typeof e.$on=="function"}function me(e){return"$on"in e}function pe(e){return(t,n)=>{function s(){const o=Array.from(A);A.clear();const r=Array.from(X);X.clear(),o.forEach(i=>i(t,n)),r.forEach(i=>i()),A.size&&queueMicrotask(s)}A.size||queueMicrotask(s),A.add(e)}}const D={};function fe(e,t){const n=performance.now(),s=typeof t=="function";e=s?`${e} (ms)`:`${e} (calls)`;const o=s?t():t,r=s?performance.now()-n:t;return D[e]?D[e].push(r):D[e]=[r],o}const x=new Map;function T(e,t={}){if(C(e)||typeof e!="object")return e;const n=t.o||new Map,s=t.op||new Map,o=Array.isArray(e),r=[],i=o?[]:Object.create(e,{});for(const c in e){const l=e[c];typeof l=="object"&&l!==null?(i[c]=C(l)?l:T(l),r.push(c)):i[c]=l}const a=c=>(l,h)=>{let m=n.get(l),_=s.get(h);m||(m=new Set,n.set(l,m)),_||(_=new Set,s.set(h,_)),m[c](h),_[c](l)},u=a("add"),f=a("delete"),y=(c,l,h)=>{n.has(c)&&n.get(c).forEach(m=>m(l,h))},d={$on:u,$off:f,_em:y,_st:()=>({o:n,op:s,r:i,p:p._p}),_p:void 0},p=new Proxy(i,{has(c,l){return l in d||l in c},get(...c){const[,l]=c;if(Reflect.has(d,l))return Reflect.get(d,l);const h=Reflect.get(...c);return he(p,l),o&&l in Array.prototype?ve(l,i,p,h):h},set(...c){const[l,h,m]=c,_=Reflect.get(l,h);if(Reflect.has(d,h))return Reflect.set(d,h,m);if(m&&C(_)){const P=_,O=P._st(),B=C(m)?ye(m,P):T(m,O);return Reflect.set(l,h,B),y(h,B),O.o.forEach((Ve,j)=>{const U=Reflect.get(_,j),K=Reflect.get(B,j);U!==K&&P._em(j,K,U)}),!0}const k=Reflect.set(...c);return k&&(_!==m&&y(h,m,_),p._p&&p._p[1]._em(...p._p)),k}});return t.p&&(p._p=t.p),r.map(c=>{p[c]._p=[c,p]}),p}function he(e,t){x.forEach(n=>{let s=n.get(e);s||(s=new Set,n.set(e,s)),s.add(t)})}function ve(e,t,n,s){const o=(...r)=>{const i=Array.prototype[e].call(t,...r);if(t.forEach((a,u)=>n._em(String(u),a)),n._p){const[a,u]=n._p;u._em(a,n)}return i};switch(e){case"shift":case"pop":case"sort":case"reverse":case"copyWithin":return o;case"unshift":case"push":case"fill":return(...r)=>o(...r.map(i=>T(i)));case"splice":return function(r,i,...a){return arguments.length===1?o(r):o(r,i,...a.map(u=>T(u)))};default:return s}}function ye(e,t){const n=t._st();return n.o&&n.o.forEach((s,o)=>{s.forEach(r=>{e.$on(o,r)})}),n.p&&(e._p=n.p),e}function W(e,t){const n=Symbol();x.has(n)||x.set(n,new Map);let s=new Map;const o=pe(r);function r(){x.set(n,new Map);const i=e(),a=x.get(n);return x.delete(n),s.forEach((u,f)=>{const y=a.get(f);y&&y.forEach(S=>u.delete(S)),u.forEach(S=>f.$off(S,o))}),a.forEach((u,f)=>{u.forEach(y=>f.$on(y,o))}),s=a,t?t(i):i}return me(e)&&e.$on(r),r()}const I=new WeakMap,Z={},te="➳❍",ne="❍⇚",se=`<!--${te}-->`,be=`<!--${ne}-->`;function ie(e,...t){const n=[];let s="";const o=(a,u)=>{if(typeof a=="function"){let f=()=>{};return n.push(Object.assign((...y)=>a(...y),{e:a,$on:y=>{f=y},_up:y=>{a=y,f()}})),u+se}return Array.isArray(a)?a.reduce((f,y)=>o(y,f),u):u+a},r=()=>(s||(!t.length&&e.length===1&&e[0]===""?s="<!---->":s=e.reduce(function(u,f,y){return u+=f,t[y]!==void 0?o(t[y],u):u},"")),s),i=a=>{const u=oe(r()),f=Y(u,{i:0,e:n});return a?f(a):f()};return i.isT=!0,i._k=0,i._h=()=>[r(),n,i._k],i.key=a=>(i._k=a,i),i}function Y(e,t){let n,s=0;const o=e.childNodes;for(;n=o.item(s++);){if(n.nodeType===8&&n.nodeValue===te){$e(n,t);continue}n instanceof Element&&ge(n,t),n.hasChildNodes()&&Y(n,t),n instanceof HTMLOptionElement&&(n.selected=n.defaultSelected)}return r=>r?(r.appendChild(e),r):e}function ge(e,t){var n;const s=[];let o=0,r;for(;r=e.attributes[o++];){if(t.i>=t.e.length)return;if(r.value!==se)continue;let i=r.name;const a=t.e[t.i++];if(i.charAt(0)==="@"){const u=i.substring(1);e.addEventListener(u,a),I.has(e)||I.set(e,new Map),(n=I.get(e))===null||n===void 0||n.set(u,a),s.push(i)}else{const u=i==="value"&&"value"in e||i==="checked"||i.startsWith(".")&&(i=i.substring(1));W(a,f=>{u&&(e[i]=f,e.getAttribute(i)!=f&&(f=!1)),f!==!1?e.setAttribute(i,f):(e.removeAttribute(i),o--)})}}s.forEach(i=>e.removeAttribute(i))}function _e(e){e.forEach(ke)}function ke(e){var t;e.remove(),(t=I.get(e))===null||t===void 0||t.forEach((n,s)=>e.removeEventListener(s,n))}function $e(e,t){var n;const s=t.e[t.i++];let o;if(s&&z(s.e))o=G().add(s.e)();else{let r;o=(r=W(s,i=>we(i,r)))()}(n=e.parentNode)===null||n===void 0||n.replaceChild(o,e)}function we(e,t){const n=typeof t=="function",s=n?t:G();return Array.isArray(e)?e.forEach(o=>fe("partialAdd",()=>s.add(o))):s.add(e),n&&s._up(),s}function oe(e){var t;const s=((t=Z[e])!==null&&t!==void 0?t:(()=>{const o=document.createElement("template");return o.innerHTML=e,Z[e]=o})()).content.cloneNode(!0);return s.normalize(),s}function G(e=Symbol()){let t="",n={i:0,e:[]},s=[],o=[];const r=new Map,i=[],a=()=>{let d;if(s.length||f(),s.length===1&&!z(s[0].tpl)){const p=s[0];p.dom.length?p.dom[0].nodeValue=p.tpl:p.dom.push(document.createTextNode(p.tpl)),d=p.dom[0]}else d=y(Y(oe(t),n)());return u(),d};a.ch=()=>o,a.l=0,a.add=d=>{if(!d&&d!==0)return a;let p=[],c,l="";z(d)&&([l,p,c]=d._h()),t+=l,t+=be;const h=c&&r.get(c),m=h||{html:l,exp:p,dom:[],tpl:d,key:c};return s.push(m),c&&(h?h.exp.forEach((_,k)=>_._up(p[k].e)):r.set(c,m)),n.e.push(...p),a.l++,a},a._up=()=>{const d=G(e);let p=0,c=o[0].dom[0];s.length||f(document.createComment(""));const l=()=>{if(!d.l)return;const m=d(),_=m.lastChild;c[p?"after":"before"](m),S(d,s,p),c=_};s.forEach((m,_)=>{const k=o[_];m.key&&m.dom.length?(l(),(!k||k.dom!==m.dom)&&c[_?"after":"before"](...m.dom),c=m.dom[m.dom.length-1]):k&&m.html===k.html&&!k.key?(l(),k.exp.forEach((P,O)=>P._up(m.exp[O].e)),m.exp=k.exp,m.dom=k.dom,c=m.dom[m.dom.length-1],Ee(m)&&c instanceof Text&&(c.nodeValue=m.tpl)):(k&&m.html!==k.html&&!k.key&&i.push(...k.dom),d.l||(p=_),d.add(m.tpl))}),l();let h=c==null?void 0:c.nextSibling;for(;h&&e in h;)i.push(h),h=h.nextSibling;_e(i),u()};const u=()=>{i.length=0,t="",a.l=0,n={i:0,e:[]},o=[...s],s=[]},f=d=>{t="<!---->",s.push({html:t,exp:[],dom:d?[d]:[],tpl:ie`${t}`,key:0})},y=d=>{let p=0;const c=[];return d.childNodes.forEach(l=>{if(l.nodeType===8&&l.data===ne){p++,c.push(l);return}Object.defineProperty(l,e,{value:e}),s[p].dom.push(l)}),c.forEach(l=>l.remove()),d},S=(d,p,c)=>{d.ch().forEach((l,h)=>{p[c+h].dom=l.dom})};return a}function Ee(e){return e.dom.length===1&&!z(e.tpl)}const g=ie,re=W;function M(e){return T(e)}const v=M({tasks:[],questText:"spaghetti",inviter:"kuviman",teamLeader:null,isSelfLeader:!1,alertText:""}),N={base:{priority:0,template:Te,closeOnInteract:!0},settings:{priority:1,template:Ie,closeOnInteract:!0},races:{priority:1,template:Ce,closeOnInteract:!0},race_list:{priority:2,template:Re,closeOnInteract:!0},race_editor:{priority:3,template:Oe},change_name:{priority:2,template:ze},job:{priority:5,template:Ae,closeOnInteract:!0},invite:{priority:10,template:qe},alert:{priority:20,template:Pe,closeOnInteract:!0}};function Se(e){v.alertText=e,L("alert")}function R(e){v.tasks.shift(),L(e)}function w(e){v.tasks=v.tasks.filter(t=>t!==e)}function xe(e){if(v.tasks.length===0){e||L("base");return}if(N[v.tasks[0]].closeOnInteract){v.tasks.shift();return}}function L(e){v.tasks.includes(e)||v.tasks.push(e),v.tasks.sort((t,n)=>N[n].priority-N[t].priority)}function Le(){return g`
    <div
      id="phone"
  ...
  `}function Ae(){function e(){w("job")}return g`
    <div class="screen">
  ...
  `}function qe(){function e(t){w("invite"),$({type:t})}return g`
  ...
  `}function Te(){function e(){$({type:"leave_team"}),w("base")}let t="./icons";return t="assets/icons",g`
    <div class="screen">
  ...
  `}function Re(){let e=JSON.parse(localStorage.getItem("./races")||'{ "races": {} }');function t(n){return function(){$({type:"race_start",name:n}),w("race_list")}}return g`<div class="screen">
    Pick a Race:
    <div class="race-list">
  ...
  </div>`}function Oe(){function e(){$({type:"race_edit_cancel"}),w("race_editor")}function t(){const n=document.getElementById("race-name").value;$({type:"race_edit_submit",name:n}),w("race_editor")}return g`
    <div class="screen">
      Race Editor
  ...
  `}function Ce(){function e(){if(!v.isSelfLeader){Se("You must be the leader of a race club.");return}R("race_list")}function t(){R("race_editor"),$({type:"race_create"})}return g`
    <div class="screen">
      Racing
      <div class="button accept" @click="${e}">Start Race</div>
      <div class="button secondary" @click="${t}">Create Track</div>
    </div>
  `}function Ie(){return g`
    <div class="screen">
      Settings
      <div
        class="button secondary"
  ...
  `}function ze(){return g`
      <div class="screen" id="choose_name">
        Enter your name:
        <input type="text" autocomplete=off id="name_input" @keydown="${e=>{e.key==="Enter"&&(w("change_name"),$({type:"change_name",name:e.target.value}))}}" placeholder="sam"></input>
      </div>
      `}let Ne=0;const b=M({money:0,diffs:[],moneyAnimated:0,moneyWas:0});re(()=>{if(b.money!==b.moneyWas){const e=b.money-b.moneyWas;b.moneyWas=b.money,b.diffs.push({id:Ne++,amt:e}),setTimeout(()=>{b.diffs.shift()},3e3)}});let q=null;re(()=>{if(b.money,typeof q=="number")return;const e=()=>{if(b.money===b.moneyAnimated){q=null;return}const t=Math.abs(b.money-b.moneyAnimated),n=Math.max(Math.floor(t/30),1);if(t<=1){b.moneyAnimated=b.money,q=null;return}b.money>b.moneyAnimated?b.moneyAnimated+=n:b.moneyAnimated-=n,q=setTimeout(e,10)};q=setTimeout(e,10)});function Me(){return g`<div id="money" class="no-mouse">
  ...
  </div>`}const E=M({showing:!1,stats:[]});function Be(e){E.stats.push(e),E.stats.sort((t,n)=>t.place-n.place)}function je(){return g`${()=>E.showing?g`<div id="summary">

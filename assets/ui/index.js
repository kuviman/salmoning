var w=Object.defineProperty;var E=(a,e,t)=>e in a?w(a,e,{enumerable:!0,configurable:!0,writable:!0,value:t}):a[e]=t;var d=(a,e,t)=>(E(a,typeof e!="symbol"?e+"":e,t),t);(function(){const e=document.createElement("link").relList;if(e&&e.supports&&e.supports("modulepreload"))return;for(const s of document.querySelectorAll('link[rel="modulepreload"]'))o(s);new MutationObserver(s=>{for(const i of s)if(i.type==="childList")for(const r of i.addedNodes)r.tagName==="LINK"&&r.rel==="modulepreload"&&o(r)}).observe(document,{childList:!0,subtree:!0});function t(s){const i={};return s.integrity&&(i.integrity=s.integrity),s.referrerPolicy&&(i.referrerPolicy=s.referrerPolicy),s.crossOrigin==="use-credentials"?i.credentials="include":s.crossOrigin==="anonymous"?i.credentials="omit":i.credentials="same-origin",i}function o(s){if(s.ep)return;s.ep=!0;const i=t(s);fetch(s.href,i)}})();const L="modulepreload",S=function(a){return"/"+a},k={},z=function(e,t,o){let s=Promise.resolve();if(t&&t.length>0){const i=document.getElementsByTagName("link"),r=document.querySelector("meta[property=csp-nonce]"),b=(r==null?void 0:r.nonce)||(r==null?void 0:r.getAttribute("nonce"));s=Promise.all(t.map(c=>{if(c=S(c),c in k)return;k[c]=!0;const p=c.endsWith(".css"),v=p?'[rel="stylesheet"]':"";if(!!o)for(let h=i.length-1;h>=0;h--){const m=i[h];if(m.href===c&&(!p||m.rel==="stylesheet"))return}else if(document.querySelector(`link[href="${c}"]${v}`))return;const l=document.createElement("link");if(l.rel=p?"stylesheet":L,p||(l.as="script",l.crossOrigin=""),l.href=c,b&&l.setAttribute("nonce",b),document.head.appendChild(l),p)return new Promise((h,m)=>{l.addEventListener("load",h),l.addEventListener("error",()=>m(new Error(`Unable to preload CSS for ${c}`)))})}))}return s.then(()=>e()).catch(i=>{const r=new Event("vite:preloadError",{cancelable:!0});if(r.payload=i,window.dispatchEvent(r),!r.defaultPrevented)throw i})};let u;const P=async()=>{try{const e="../../salmoning.js";u=(await z(()=>import(e),[])).send_message_to_world}catch(a){console.error("salmoning.js module is not available",a),u=()=>console.log("Fallback function")}};P();class f{constructor(){d(this,"app");d(this,"money");d(this,"shop");d(this,"phone");d(this,"ques");d(this,"job");d(this,"tasks");d(this,"boundAcceptHandler");d(this,"customizables");d(this,"unlocks");var e,t,o,s,i,r,b,c,p,v,y,l,h,m,q;document.querySelector("#app").innerHTML=`
  <div>
    <div id="money">$0</div>
